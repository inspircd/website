...
The full change log can be found [on the docs site](https://docs.inspircd.org/3/change-log/#inspircd-3150) or [on GitHub](https://github.com/inspircd/inspircd/compare/v3.15.0...v3.16.0).
