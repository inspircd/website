...
InspIRCd v4 will be released at some point in the next month. If you'd like to help out with this please submit a patch or [open a feature request](https://github.com/inspircd/inspircd/issues/new?template=FEATURE_REQUEST.md).
